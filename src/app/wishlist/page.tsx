  ...
  if (wishlistedProducts.length === 0) {
    return (
      <div className="container mx-auto flex min-h-[60vh] flex-col items-center justify-center text-center">
        ...
        <h1 className="mt-8 font-headline text-4xl font-normal">Your Wishlist is Empty</h1>
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="mb-12 text-center">
        <h1 className="font-headline text-4xl font-normal tracking-tight sm:text-5xl">Your Wishlist</h1>
