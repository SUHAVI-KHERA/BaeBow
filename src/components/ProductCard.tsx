    ...
    <div className="group relative overflow-hidden rounded-2xl bg-card shadow-xl transition-transform duration-300 hover:scale-102">
      ...
      <div className="absolute top-3 right-3 z-10 flex flex-col gap-2">
        <Button 
          size="icon" 
          variant="ghost" 
          className="h-9 w-9 rounded-full bg-white/80 text-foreground backdrop-blur-sm hover:bg-white"
          onClick={handleWishlistToggle}
        >
          <Heart className={cn("h-4 w-4", isItemWishlisted && "fill-destructive text-destructive")} />
      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-4">
          ...
          <Button 
            size="icon" 
            className="h-10 w-10 flex-shrink-0 rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90" 
